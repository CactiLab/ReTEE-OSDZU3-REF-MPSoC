...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L microblaze_v11_0_15 -L lmb_v10_v3_0_15 -L lmb_bram_if_cntlr_v4_0_26 -L blk_mem_gen_v8_4_11 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_28 -L proc_sys_reset_v5_0_17 -L axi_intc_v4_1_21 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_35 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_crossbar_v2_1_37 -L axi_protocol_converter_v2_1_36 -L axi_clock_converter_v2_1_34 -L axi_dwidth_converter_v2_1_36 -L axi_mmu_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot OSDZU3x_BYOTEE xil_defaultlib.OSDZU3x_BYOTEE xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim OSDZU3x_BYOTEE -key {Behavioral:sim_1:Functional:OSDZU3x_BYOTEE} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/bd_365d.protoinst" -protoinst "protoinst_files/bd_36ad.protoinst" -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/OSDZU3x_Tutorial.protoinst" -protoinst "protoinst_files/OSDZU3x_BYOTEE.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb OSDZU3x_BYOTEE.wdb xsim.dir libdpi.so)

...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ OSDZU3x_BYOTEE_axi_uartlite_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "OSDZU3x_BYOTEE_axi_uartlite_0_0,axi_uartlite,{}" *) (* core_generation_info = "OSDZU3x_BYOTEE_axi_uartlite_0_0,axi_uartlite,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_uartlite,x_ipVersion=2.0,x_ipCoreRevision=39,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_S_AXI_ACLK_FREQ_HZ=99999001,C_S_AXI_ADDR_WIDTH=4,C_S_AXI_DATA_WIDTH=32,C_BAUDRATE=9600,C_DATA_BITS=8,C_USE_PARITY=0,C_ODD_PARITY=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 

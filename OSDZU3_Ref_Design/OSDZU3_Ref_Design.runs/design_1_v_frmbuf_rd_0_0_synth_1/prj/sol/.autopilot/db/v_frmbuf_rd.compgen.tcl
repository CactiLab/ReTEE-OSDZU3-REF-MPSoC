...
set name design_1_v_frmbuf_rd_0_0_mul_15s_3ns_15_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_0_0_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}

...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img \
    op interface \
    ports { img_dout { I 32 vector } img_empty_n { I 1 bit } img_read { O 1 bit } img_num_data_valid { I 3 vector } img_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_thr_or17 \
    op interface \
    ports { thr_or17 { I 1 vector } } \
} "
}

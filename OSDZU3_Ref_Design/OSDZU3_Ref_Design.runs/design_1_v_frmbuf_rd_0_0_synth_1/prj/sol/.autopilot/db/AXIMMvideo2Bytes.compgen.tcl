...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_din { O 64 vector } bytePlanes_full_n { I 1 bit } bytePlanes_write { O 1 bit } bytePlanes_num_data_valid { I 11 vector } bytePlanes_fifo_cap { I 11 vector } } \
} "
}

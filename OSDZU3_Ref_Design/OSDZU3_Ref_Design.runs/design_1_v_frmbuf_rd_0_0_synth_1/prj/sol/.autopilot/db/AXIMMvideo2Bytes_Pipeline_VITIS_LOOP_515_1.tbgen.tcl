set moduleName AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_515_1
set isTopModule 0
...
set cdfgNum 12
set C_modelName {AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_515_1}
...
set Spec2ImplPortList { 
	...
	bytePlanes { ap_fifo {  { bytePlanes_din fifo_data_in 1 64 }  { bytePlanes_full_n fifo_status 0 1 }  { bytePlanes_write fifo_port_we 1 1 }  { bytePlanes_num_data_valid fifo_status_num_data_valid 0 11 }  { bytePlanes_fifo_cap fifo_update 0 11 } } }
}

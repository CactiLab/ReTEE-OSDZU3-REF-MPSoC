...
attribute shreg_extract : string;
    ...
    signal Bytes2MultiPixStream_U0_img_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal img_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component design_1_v_frmbuf_rd_0_0_fifo_w64_d961_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_rd_0_0_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    bytePlanes_U : component design_1_v_frmbuf_rd_0_0_fifo_w64_d961_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    img_U : component design_1_v_frmbuf_rd_0_0_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,

...
#ifdef SDT
XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_Config *XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_LookupConfig(UINTPTR BaseAddress) {
	XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_Config *ConfigPtr = NULL;

	int Index;

	for (Index = (u32)0x0; XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_ConfigTable[Index].Name != NULL; Index++) {
		if (!BaseAddress || XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_ConfigTable[Index].Design_1_v_frmbuf_rd_0_0_ctrl_BaseAddress == BaseAddress) {
...
int XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_Initialize(XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd *InstancePtr, UINTPTR BaseAddress) {
	XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_Config *ConfigPtr;

	Xil_AssertNonvoid(InstancePtr != NULL);

	ConfigPtr = XDesign_1_v_frmbuf_rd_0_0_v_frmbuf_rd_LookupConfig(BaseAddress);
	if (ConfigPtr == NULL) {

...
wire   [31:0] Bytes2MultiPixStream_U0_img_din;
...
design_1_v_frmbuf_rd_0_0_fifo_w64_d961_B bytePlanes_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_0_0_fifo_w32_d2_S img_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),

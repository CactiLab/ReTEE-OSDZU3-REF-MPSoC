...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video2_TVALID { I 1 bit } s_axis_video2_TDATA { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video2_TREADY { O 1 bit } s_axis_video2_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sof_10_i \
    op interface \
    ports { sof_10_i { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_last_21_i \
    op interface \
    ports { axi_last_21_i { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_17_i \
    op interface \
    ports { axi_data_17_i { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer2_din { O 24 vector } srcLayer2_full_n { I 1 bit } srcLayer2_write { O 1 bit } srcLayer2_num_data_valid { I 3 vector } srcLayer2_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_eol_i_out \
    op interface \
    ports { eol_i_out { O 1 vector } eol_i_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 227 \
    name axi_data_18_i_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_18_i_out \
    op interface \
    ports { axi_data_18_i_out { O 24 vector } axi_data_18_i_out_ap_vld { O 1 bit } } \
} "
}

set moduleName v_mix_upsample_false_7
set isTopModule 0
...
set cdfgNum 53
set C_modelName {v_mix_upsample<false>.7}
...
set portList { 
	...
	{ srcLayer1x_num_data_valid sc_in sc_lv 32 signal 4 } 
	{ srcLayer1x_fifo_cap sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 

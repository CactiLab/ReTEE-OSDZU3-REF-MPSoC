set moduleName v_mix_yuv2rgb_true_Pipeline_VITIS_LOOP_941_2
set isTopModule 0
...
set cdfgNum 53
set C_modelName {v_mix_yuv2rgb<true>_Pipeline_VITIS_LOOP_941_2}
...
set portList { 
	...
	{ srcLayer1Yuv_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ srcLayer1Yuv_fifo_cap sc_in sc_lv 3 signal 1 } 
	...
	{ srcLayer1Rgb_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ srcLayer1Rgb_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "3846"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "3846"}
]}
...
set Spec2ImplPortList { 
	...
	srcLayer1Yuv { ap_fifo {  { srcLayer1Yuv_dout fifo_data_in 0 24 }  { srcLayer1Yuv_empty_n fifo_status 0 1 }  { srcLayer1Yuv_read fifo_port_we 1 1 }  { srcLayer1Yuv_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer1Yuv_fifo_cap fifo_update 0 3 } } }
	srcLayer1Rgb { ap_fifo {  { srcLayer1Rgb_din fifo_data_in 1 24 }  { srcLayer1Rgb_full_n fifo_status 0 1 }  { srcLayer1Rgb_write fifo_port_we 1 1 }  { srcLayer1Rgb_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer1Rgb_fifo_cap fifo_update 0 32 } } }
}

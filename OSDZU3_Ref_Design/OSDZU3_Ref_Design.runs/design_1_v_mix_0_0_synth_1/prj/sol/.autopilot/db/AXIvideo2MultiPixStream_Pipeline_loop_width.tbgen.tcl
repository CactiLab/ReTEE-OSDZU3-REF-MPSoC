...
set C_modelArgList {
	{ sof_10_i int 1 regular  }
	{ axi_last_21_i int 1 regular  }
	{ axi_data_17_i int 24 regular  }
	...
	{ axi_data_18_i_out int 24 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "sof_10_i", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "axi_last_21_i", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "axi_data_17_i", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_18_i_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sof_10_i sc_in sc_lv 1 signal 0 } 
	{ axi_last_21_i sc_in sc_lv 1 signal 1 } 
	{ axi_data_17_i sc_in sc_lv 24 signal 2 } 
	...
	{ axi_data_18_i_out sc_out sc_lv 24 signal 13 } 
	{ axi_data_18_i_out_ap_vld sc_out sc_logic 1 outvld 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sof_10_i", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sof_10_i", "role": "default" }} , 
 	{ "name": "axi_last_21_i", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "axi_last_21_i", "role": "default" }} , 
 	{ "name": "axi_data_17_i", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_17_i", "role": "default" }} , 
 	...
 	{ "name": "axi_data_18_i_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_18_i_out", "role": "default" }} , 
 	{ "name": "axi_data_18_i_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_data_18_i_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	sof_10_i { ap_none {  { sof_10_i in_data 0 1 } } }
	axi_last_21_i { ap_none {  { axi_last_21_i in_data 0 1 } } }
	axi_data_17_i { ap_none {  { axi_data_17_i in_data 0 24 } } }
	cols_i { ap_none {  { cols_i in_data 0 12 } } }
	srcLayer2 { ap_fifo {  { srcLayer2_din fifo_data_in 1 24 }  { srcLayer2_full_n fifo_status 0 1 }  { srcLayer2_write fifo_port_we 1 1 }  { srcLayer2_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer2_fifo_cap fifo_update 0 3 } } }
	...
	axi_data_18_i_out { ap_vld {  { axi_data_18_i_out out_data 1 24 }  { axi_data_18_i_out_ap_vld out_vld 1 1 } } }
}

set moduleName v_mix_420_to_422_false_6_Pipeline_VITIS_LOOP_76_2
set isTopModule 0
...
set cdfgNum 53
set C_modelName {v_mix_420_to_422<false>.6_Pipeline_VITIS_LOOP_76_2}
...
set portList { 
	...
	{ srcLayer1_dout sc_in sc_lv 24 signal 1 } 
	{ srcLayer1_empty_n sc_in sc_logic 1 signal 1 } 
	{ srcLayer1_read sc_out sc_logic 1 signal 1 } 
	{ srcLayer1_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ srcLayer1_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ srcLayer1Yuv422_din sc_out sc_lv 24 signal 2 } 
	{ srcLayer1Yuv422_full_n sc_in sc_logic 1 signal 2 } 
	{ srcLayer1Yuv422_write sc_out sc_logic 1 signal 2 } 
	{ srcLayer1Yuv422_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ srcLayer1Yuv422_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer1Yuv422_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "srcLayer1Yuv422", "role": "num_data_valid" }} , 
 	{ "name": "srcLayer1Yuv422_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "srcLayer1Yuv422", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	srcLayer1 { ap_fifo {  { srcLayer1_dout fifo_data_in 0 24 }  { srcLayer1_empty_n fifo_status 0 1 }  { srcLayer1_read fifo_port_we 1 1 }  { srcLayer1_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer1_fifo_cap fifo_update 0 3 } } }
	srcLayer1Yuv422 { ap_fifo {  { srcLayer1Yuv422_din fifo_data_in 1 24 }  { srcLayer1Yuv422_full_n fifo_status 0 1 }  { srcLayer1Yuv422_write fifo_port_we 1 1 }  { srcLayer1Yuv422_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer1Yuv422_fifo_cap fifo_update 0 32 } } }
}

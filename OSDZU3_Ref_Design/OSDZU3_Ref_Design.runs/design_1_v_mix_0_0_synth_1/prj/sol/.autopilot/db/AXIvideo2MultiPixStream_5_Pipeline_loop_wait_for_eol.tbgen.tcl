set moduleName AXIvideo2MultiPixStream_5_Pipeline_loop_wait_for_eol
set isTopModule 0
...
set cdfgNum 53
set C_modelName {AXIvideo2MultiPixStream.5_Pipeline_loop_wait_for_eol}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ axi_data_3_i_reload int 24 regular  }
	...
	{ axi_data_4_i_out int 24 regular {pointer 1}  }
	{ axi_last_4_i_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_3_i_reload", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_4_i_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "axi_last_4_i_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ axi_data_3_i_reload sc_in sc_lv 24 signal 0 } 
	{ select_ln3436_i sc_in sc_lv 1 signal 1 } 
	{ eol_i_reload sc_in sc_lv 1 signal 2 } 
	{ s_axis_video1_TDATA sc_in sc_lv 24 signal 3 } 
	{ s_axis_video1_TREADY sc_out sc_logic 1 inacc 9 } 
	{ s_axis_video1_TKEEP sc_in sc_lv 3 signal 4 } 
	{ s_axis_video1_TSTRB sc_in sc_lv 3 signal 5 } 
	...
	{ axi_data_4_i_out sc_out sc_lv 24 signal 10 } 
	{ axi_data_4_i_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ axi_last_4_i_out sc_out sc_lv 1 signal 11 } 
	{ axi_last_4_i_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_3_i_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_3_i_reload", "role": "default" }} , 
 	...
 	{ "name": "axi_data_4_i_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_4_i_out", "role": "default" }} , 
 	{ "name": "axi_data_4_i_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_data_4_i_out", "role": "ap_vld" }} , 
 	{ "name": "axi_last_4_i_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "axi_last_4_i_out", "role": "default" }} , 
 	{ "name": "axi_last_4_i_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_last_4_i_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	axi_data_3_i_reload { ap_none {  { axi_data_3_i_reload in_data 0 24 } } }
	...
	axi_data_4_i_out { ap_vld {  { axi_data_4_i_out out_data 1 24 }  { axi_data_4_i_out_ap_vld out_vld 1 1 } } }
	axi_last_4_i_out { ap_vld {  { axi_last_4_i_out out_data 1 1 }  { axi_last_4_i_out_ap_vld out_vld 1 1 } } }
}

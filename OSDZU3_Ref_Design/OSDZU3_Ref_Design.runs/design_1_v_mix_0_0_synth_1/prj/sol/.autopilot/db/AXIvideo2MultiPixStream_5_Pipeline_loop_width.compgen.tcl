...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video1_TVALID { I 1 bit } s_axis_video1_TDATA { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video1_TREADY { O 1 bit } s_axis_video1_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_last_2_i \
    op interface \
    ports { axi_last_2_i { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_2_i \
    op interface \
    ports { axi_data_2_i { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer1_din { O 24 vector } srcLayer1_full_n { I 1 bit } srcLayer1_write { O 1 bit } srcLayer1_num_data_valid { I 3 vector } srcLayer1_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 95 \
    name axi_data_3_i_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_3_i_out \
    op interface \
    ports { axi_data_3_i_out { O 24 vector } axi_data_3_i_out_ap_vld { O 1 bit } } \
} "
}

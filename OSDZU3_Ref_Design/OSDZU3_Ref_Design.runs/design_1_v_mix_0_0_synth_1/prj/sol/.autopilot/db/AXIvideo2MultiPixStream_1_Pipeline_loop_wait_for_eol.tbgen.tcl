set moduleName AXIvideo2MultiPixStream_1_Pipeline_loop_wait_for_eol
set isTopModule 0
...
set cdfgNum 53
set C_modelName {AXIvideo2MultiPixStream.1_Pipeline_loop_wait_for_eol}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ axi_data_11_reload int 24 regular  }
	{ select_ln3436 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_11_reload", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln3436", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ axi_data_11_reload sc_in sc_lv 24 signal 0 } 
	{ select_ln3436 sc_in sc_lv 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_11_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_11_reload", "role": "default" }} , 
 	{ "name": "select_ln3436", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln3436", "role": "default" }} , 
...
set Spec2ImplPortList { 
	axi_data_11_reload { ap_none {  { axi_data_11_reload in_data 0 24 } } }
	select_ln3436 { ap_none {  { select_ln3436 in_data 0 1 } } }

; ModuleID = '/home/e/Documents/research/byotee/OSDZU3_Ref_Design/OSDZU3_Ref_Design.runs/design_1_v_mix_0_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @arraycpy_hls.p0a3i16([3 x i16]* "orig.arg.no"="0" %dst, [3 x i16]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) local_unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a3i8([3 x i8]* noalias align 512 "orig.arg.no"="0" %dst, [3 x i8]* noalias readonly "orig.arg.no"="1" %src) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3i8([3 x i8]* "orig.arg.no"="0" %dst, [3 x i8]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) local_unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3i16.21.22(i16* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i16* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i16* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x i16]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [3 x i16]* %src, null
...
dst.addr.exit:                                    ; preds = %dst.addr.case.2, %dst.addr.case.1, %dst.addr.case.0, %for.loop
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3i16.20.23(i16* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i16* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i16* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x i16]* noalias readonly "orig.arg.no"="1" %src) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3i16.21.22(i16* nonnull %dst_0, i16* %dst_1, i16* %dst_2, [3 x i16]* nonnull %src, i64 3)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3i8.25.26(i8* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i8* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i8* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x i8]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [3 x i8]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3i8.24.27(i8* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i8* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i8* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x i8]* noalias readonly "orig.arg.no"="1" %src) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3i8.25.26(i8* nonnull %dst_0, i8* %dst_1, i8* %dst_2, [3 x i8]* nonnull %src, i64 3)
  br label %ret
...
src.addr.exit:                                    ; preds = %src.addr.case.2, %src.addr.case.1, %src.addr.case.0, %for.loop
  %3 = phi i16 [ %_0, %src.addr.case.0 ], [ %_1, %src.addr.case.1 ], [ %_2, %src.addr.case.2 ], [ undef, %for.loop ]
  store i16 %3, i16* %dst.addr, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* noalias "orig.arg.no"="0" %dst, i16* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i16* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, i16* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3i16.33.34([3 x i16]* nonnull %dst, i16* nonnull %src_0, i16* %src_1, i16* %src_2, i64 3)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3i8.37.38([3 x i8]* "orig.arg.no"="0" %dst, i8* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i8* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i8* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i64 "orig.arg.no"="2" %num) #1 {
entry:
...
src.addr.exit:                                    ; preds = %src.addr.case.2, %src.addr.case.1, %src.addr.case.0, %for.loop
  %3 = phi i8 [ %_0, %src.addr.case.0 ], [ %_1, %src.addr.case.1 ], [ %_2, %src.addr.case.2 ], [ undef, %for.loop ]
  store i8 %3, i8* %dst.addr, align 1
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3i8.36.39([3 x i8]* noalias "orig.arg.no"="0" %dst, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2) #2 {
entry:
  %0 = icmp eq [3 x i8]* %dst, null
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3i8.37.38([3 x i8]* nonnull %dst, i8* nonnull %src_0, i8* %src_1, i8* %src_2, i64 3)
  br label %ret
...
entry:
  ...
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %3, i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2)
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %4, i16* align 512 %_01, i16* align 512 %_12, i16* align 512 %_23)
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %5, i16* align 512 %_04, i16* align 512 %_15, i16* align 512 %_26)
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %6, i16* align 512 %_07, i16* align 512 %_18, i16* align 512 %_29)
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %7, i16* align 512 %_010, i16* align 512 %_111, i16* align 512 %_212)
  call void @onebyonecpy_hls.p0a3i8.36.39([3 x i8]* %8, i8* align 512 %_013, i8* align 512 %_114, i8* align 512 %_215)
  call fastcc void @onebyonecpy_hls.p0a3i8([3 x i8]* %9, [3 x i8]* align 512 %10)
  call void @onebyonecpy_hls.p0a3i16.32.35([3 x i16]* %11, i16* align 512 %_016, i16* align 512 %_117, i16* align 512 %_218)
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.85"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %dst, i24* align 512 %src_V_data_V, i3* align 512 %src_V_keep_V, i3* align 512 %src_V_strb_V, i1* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i1* align 512 %src_V_id_V, i1* align 512 %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.85"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nocapture, i24* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i3* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i3* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="1.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="1.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="1.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="1.6" %_V_dest_V) unnamed_addr #6 {
entry:
  %1 = alloca i24
  %2 = alloca i3
  %3 = alloca i3
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.92"(i24* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i3* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i3* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i1* noalias align 512 "unpacked"="0.3" %dst_V_user_V, i1* noalias align 512 "unpacked"="0.4" %dst_V_last_V, i1* noalias align 512 "unpacked"="0.5" %dst_V_id_V, i1* noalias align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias %src) unnamed_addr #5 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.95"(i24* align 512 %dst_V_data_V, i3* align 512 %dst_V_keep_V, i3* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.95"(i24* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i3* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i3* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="0.4" %_V_last_V, i1* noalias nocapture align 512 "unpacked"="0.5" %_V_id_V, i1* noalias nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nocapture) unnamed_addr #6 {
entry:
...
define void @v_mix_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*, i16, i16, i16, i16, i16, i16, i32, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i16*, i8*, i8*, i8*, [3 x i8]*, i16*, i16*, i16*, i16, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #7 {
entry:
  %82 = call i8* @malloc(i64 12)
  %83 = bitcast i8* %82 to %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*
  %84 = call i8* @malloc(i64 12)
  %85 = bitcast i8* %84 to %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*
  %86 = call i8* @malloc(i64 12)
  %87 = bitcast i8* %86 to %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*
  %88 = call i8* @malloc(i64 6)
  %89 = bitcast i8* %88 to [3 x i16]*
  %90 = call i8* @malloc(i64 6)
  %91 = bitcast i8* %90 to [3 x i16]*
  %92 = call i8* @malloc(i64 6)
  %93 = bitcast i8* %92 to [3 x i16]*
  %94 = call i8* @malloc(i64 6)
  %95 = bitcast i8* %94 to [3 x i16]*
  %96 = call i8* @malloc(i64 6)
  %97 = bitcast i8* %96 to [3 x i16]*
  %98 = call i8* @malloc(i64 3)
  %99 = bitcast i8* %98 to [3 x i8]*
  %100 = call i8* @malloc(i64 6)
  %101 = bitcast i8* %100 to [3 x i16]*
  %102 = call i8* @malloc(i64 12)
  %103 = bitcast i8* %102 to %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %83, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %85, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %87, i24* %14, i3* %15, i3* %16, i1* %17, i1* %18, i1* %19, i1* %20, [3 x i16]* %89, i16* %28, i16* %29, i16* %30, [3 x i16]* %91, i16* %31, i16* %32, i16* %33, [3 x i16]* %93, i16* %34, i16* %35, i16* %36, [3 x i16]* %95, i16* %37, i16* %38, i16* %39, [3 x i16]* %97, i16* %40, i16* %41, i16* %42, [3 x i8]* %99, i8* %43, i8* %44, i8* %45, [3 x i8]* null, [3 x i8]* %46, [3 x i16]* %101, i16* %47, i16* %48, i16* %49, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %103, i24* %75, i3* %76, i3* %77, i1* %78, i1* %79, i1* %80, i1* %81)
  %104 = bitcast [3 x i16]* %89 to i16*
  %105 = bitcast [3 x i16]* %91 to i16*
  %106 = bitcast [3 x i16]* %93 to i16*
  %107 = bitcast [3 x i16]* %95 to i16*
  %108 = bitcast [3 x i16]* %97 to i16*
  %109 = bitcast [3 x i8]* %99 to i8*
  %110 = bitcast [3 x i8]* %46 to i8*
  %111 = bitcast [3 x i16]* %101 to i16*
  call void @v_mix_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %83, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %85, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %87, i16 %21, i16 %22, i16 %23, i16 %24, i16 %25, i16 %26, i32 %27, i16* %104, i16* %105, i16* %106, i16* %107, i16* %108, i8* %109, i8* %110, i16* %111, i16 %50, i32 %51, i32 %52, i32 %53, i32 %54, i32 %55, i32 %56, i32 %57, i32 %58, i32 %59, i32 %60, i32 %61, i32 %62, i32 %63, i32 %64, i32 %65, i32 %66, i32 %67, i32 %68, i32 %69, i32 %70, i32 %71, i32 %72, i32 %73, i32 %74, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %103)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %83, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %85, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %87, i24* %14, i3* %15, i3* %16, i1* %17, i1* %18, i1* %19, i1* %20, [3 x i16]* %89, i16* %28, i16* %29, i16* %30, [3 x i16]* %91, i16* %31, i16* %32, i16* %33, [3 x i16]* %93, i16* %34, i16* %35, i16* %36, [3 x i16]* %95, i16* %37, i16* %38, i16* %39, [3 x i16]* %97, i16* %40, i16* %41, i16* %42, [3 x i8]* %99, i8* %43, i8* %44, i8* %45, [3 x i8]* null, [3 x i8]* %46, [3 x i16]* %101, i16* %47, i16* %48, i16* %49, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %103, i24* %75, i3* %76, i3* %77, i1* %78, i1* %79, i1* %80, i1* %81)

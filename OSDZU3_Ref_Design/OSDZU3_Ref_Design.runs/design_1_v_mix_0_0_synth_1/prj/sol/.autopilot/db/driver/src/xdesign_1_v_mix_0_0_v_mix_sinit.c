...
XDesign_1_v_mix_0_0_v_mix_Config *XDesign_1_v_mix_0_0_v_mix_LookupConfig(UINTPTR BaseAddress) {
	...
	for (Index = (u32)0x0; XDesign_1_v_mix_0_0_v_mix_ConfigTable[Index].Name != NULL; Index++) {
		if (!BaseAddress || XDesign_1_v_mix_0_0_v_mix_ConfigTable[Index].Design_1_v_mix_0_0_ctrl_BaseAddress == BaseAddress) {
...
int XDesign_1_v_mix_0_0_v_mix_Initialize(XDesign_1_v_mix_0_0_v_mix *InstancePtr, UINTPTR BaseAddress) {
	...
	ConfigPtr = XDesign_1_v_mix_0_0_v_mix_LookupConfig(BaseAddress);
	if (ConfigPtr == NULL) {

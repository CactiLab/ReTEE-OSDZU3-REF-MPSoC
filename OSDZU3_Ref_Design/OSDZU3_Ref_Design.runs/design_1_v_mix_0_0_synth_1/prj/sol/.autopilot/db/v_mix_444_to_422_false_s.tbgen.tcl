set moduleName v_mix_444_to_422_false_s
set isTopModule 0
...
set cdfgNum 53
set C_modelName {v_mix_444_to_422<false>}
...
set portList { 
	...
	{ outYuv_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ outYuv_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ height_val sc_in sc_lv 12 signal 1 } 
	{ width_val sc_in sc_lv 12 signal 2 } 
	{ out422_din sc_out sc_lv 24 signal 3 } 
	{ out422_full_n sc_in sc_logic 1 signal 3 } 
	{ out422_write sc_out sc_logic 1 signal 3 } 
	{ out422_num_data_valid sc_in sc_lv 32 signal 3 } 
	{ out422_fifo_cap sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out422_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "out422", "role": "num_data_valid" }} , 
 	{ "name": "out422_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "out422", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	outYuv { ap_fifo {  { outYuv_dout fifo_data_in 0 24 }  { outYuv_empty_n fifo_status 0 1 }  { outYuv_read fifo_port_we 1 1 }  { outYuv_num_data_valid fifo_status_num_data_valid 0 3 }  { outYuv_fifo_cap fifo_update 0 3 } } }
	height_val { ap_stable {  { height_val in_data 0 12 } } }
	width_val { ap_stable {  { width_val in_data 0 12 } } }
	out422 { ap_fifo {  { out422_din fifo_data_in 1 24 }  { out422_full_n fifo_status 0 1 }  { out422_write fifo_port_we 1 1 }  { out422_num_data_valid fifo_status_num_data_valid 0 32 }  { out422_fifo_cap fifo_update 0 32 } } }
}

...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_last_12 \
    op interface \
    ports { axi_last_12 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_10 \
    op interface \
    ports { axi_data_10 { I 24 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_srcLayer0 \
    op interface \
    ports { srcLayer0_din { O 24 vector } srcLayer0_full_n { I 1 bit } srcLayer0_write { O 1 bit } srcLayer0_num_data_valid { I 3 vector } srcLayer0_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 24 \
    name axi_data_11_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_axi_data_11_out \
    op interface \
    ports { axi_data_11_out { O 24 vector } axi_data_11_out_ap_vld { O 1 bit } } \
} "
}

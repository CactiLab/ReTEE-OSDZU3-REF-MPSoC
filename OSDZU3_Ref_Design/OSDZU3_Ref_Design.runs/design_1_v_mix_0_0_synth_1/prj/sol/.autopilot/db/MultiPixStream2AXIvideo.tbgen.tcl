...
set C_modelArgList {
	...
	{ WidthOut uint 12 regular {ap_stable 0} }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "out420", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "WidthOut", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out420_dout sc_in sc_lv 24 signal 0 } 
	{ out420_empty_n sc_in sc_logic 1 signal 0 } 
	{ out420_read sc_out sc_logic 1 signal 0 } 
	{ out420_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ out420_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ WidthOut sc_in sc_lv 12 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "WidthOut", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "WidthOut", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "8305202"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "8305202"}
]}
...
set Spec2ImplPortList { 
	out420 { ap_fifo {  { out420_dout fifo_data_in 0 24 }  { out420_empty_n fifo_status 0 1 }  { out420_read fifo_port_we 1 1 }  { out420_num_data_valid fifo_status_num_data_valid 0 3 }  { out420_fifo_cap fifo_update 0 3 } } }
	...
	WidthOut { ap_stable {  { WidthOut in_data 0 12 } } }
}

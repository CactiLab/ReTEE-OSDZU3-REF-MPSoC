set moduleName v_mix_420_to_422_false_2_Pipeline_VITIS_LOOP_76_2
set isTopModule 0
...
set cdfgNum 53
set C_modelName {v_mix_420_to_422<false>.2_Pipeline_VITIS_LOOP_76_2}
...
set portList { 
	...
	{ srcLayer0_dout sc_in sc_lv 24 signal 1 } 
	{ srcLayer0_empty_n sc_in sc_logic 1 signal 1 } 
	{ srcLayer0_read sc_out sc_logic 1 signal 1 } 
	{ srcLayer0_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ srcLayer0_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ srcLayer0Yuv422_din sc_out sc_lv 24 signal 2 } 
	{ srcLayer0Yuv422_full_n sc_in sc_logic 1 signal 2 } 
	{ srcLayer0Yuv422_write sc_out sc_logic 1 signal 2 } 
	{ srcLayer0Yuv422_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ srcLayer0Yuv422_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	srcLayer0 { ap_fifo {  { srcLayer0_dout fifo_data_in 0 24 }  { srcLayer0_empty_n fifo_status 0 1 }  { srcLayer0_read fifo_port_we 1 1 }  { srcLayer0_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0_fifo_cap fifo_update 0 3 } } }
	srcLayer0Yuv422 { ap_fifo {  { srcLayer0Yuv422_din fifo_data_in 1 24 }  { srcLayer0Yuv422_full_n fifo_status 0 1 }  { srcLayer0Yuv422_write fifo_port_we 1 1 }  { srcLayer0Yuv422_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer0Yuv422_fifo_cap fifo_update 0 32 } } }
}

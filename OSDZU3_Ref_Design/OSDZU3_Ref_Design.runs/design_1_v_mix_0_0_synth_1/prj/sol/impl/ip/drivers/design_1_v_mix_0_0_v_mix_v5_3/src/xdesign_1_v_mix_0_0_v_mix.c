...
void XDesign_1_v_mix_0_0_v_mix_Set_layerAlpha_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERALPHA_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerAlpha_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERALPHA_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerStartX_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTARTX_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerStartX_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTARTX_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerStartY_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTARTY_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerStartY_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTARTY_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerWidth_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERWIDTH_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerWidth_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERWIDTH_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerStride_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTRIDE_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerStride_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSTRIDE_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerHeight_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERHEIGHT_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerHeight_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERHEIGHT_2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layerScaleFactor_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSCALEFACTOR_2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layerScaleFactor_2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYERSCALEFACTOR_2_DATA);
    return Data;
}

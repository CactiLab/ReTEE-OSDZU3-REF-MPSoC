...
module design_1_v_mix_0_0_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln107_fu_78_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln107_fu_78_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((srcLayer2x_full_n == 1'b0) | (srcLayer2Rgb_empty_n == 1'b0));
end
...
assign icmp_ln107_fu_78_p2 = ((ap_sig_allocacmp_x_7 == empty) ? 1'b1 : 1'b0);

assign srcLayer2x_din = srcLayer2Rgb_dout;

assign x_8_fu_84_p2 = (ap_sig_allocacmp_x_7 + 12'd1);

endmodule //design_1_v_mix_0_0_v_mix_upsample_false_Pipeline_VITIS_LOOP_107_2

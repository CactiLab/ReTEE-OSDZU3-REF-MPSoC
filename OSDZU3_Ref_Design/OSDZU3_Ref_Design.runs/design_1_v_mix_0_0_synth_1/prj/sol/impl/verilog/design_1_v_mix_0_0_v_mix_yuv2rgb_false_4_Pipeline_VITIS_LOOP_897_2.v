...
module design_1_v_mix_0_0_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln897_fu_80_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    srcLayer0Yuv_blk_n;
wire    ap_block_pp0_stage0_grp1;
reg    outLayer0_blk_n;
reg   [11:0] x_fu_48;
wire   [11:0] x_6_fu_86_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln897_fu_80_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln897_fu_80_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        srcLayer0Yuv_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        srcLayer0Yuv_read = 1'b1;
    end else begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((outLayer0_full_n == 1'b0) | (srcLayer0Yuv_empty_n == 1'b0));
end
...
assign icmp_ln897_fu_80_p2 = ((ap_sig_allocacmp_x_5 == width) ? 1'b1 : 1'b0);

assign outLayer0_din = srcLayer0Yuv_dout;

assign x_6_fu_86_p2 = (ap_sig_allocacmp_x_5 + 12'd1);

endmodule //design_1_v_mix_0_0_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2

...
HD_PWD='/home/e/Documents/research/byotee/OSDZU3_Ref_Design/OSDZU3_Ref_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OSDZU3x_BYOTEE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OSDZU3x_BYOTEE_wrapper.tcl -notrace

...
entity design_1_v_frmbuf_rd_1_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity design_1_v_frmbuf_rd_1_0_regslice_both;

architecture behave of design_1_v_frmbuf_rd_1_0_regslice_both is

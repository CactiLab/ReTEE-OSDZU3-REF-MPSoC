...
entity design_1_v_frmbuf_rd_1_0_CTRL_s_axi is
generic (
...
end entity design_1_v_frmbuf_rd_1_0_CTRL_s_axi;
...
architecture behave of design_1_v_frmbuf_rd_1_0_CTRL_s_axi is
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_AP_CTRL =>
                        ...
                        rdata_data(6) <= int_flush_done;
                        rdata_data(5) <= int_flush;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_stride(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_frm_buffer(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_frm_buffer2(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_frm_buffer3(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then

...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_1_0_fifo_w64_d961_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_plane0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_1_0_fifo_w64_d961_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_plane1_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_1_0_fifo_w24_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {img_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_1_0_start_for_Bytes2MultiPixStream_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Bytes2MultiPixStream_U0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frmbuf_rd_1_0_start_for_MultiPixStream2AXIvideo_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_MultiPixStream2AXIvideo_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val1 { I 12 vector } width_val1_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val4 { I 12 vector } height_val4_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 105 \
    name video_format_val7 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_video_format_val7 \
    op interface \
    ports { video_format_val7 { I 6 vector } video_format_val7_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 106 \
    name WidthInBytes_val9 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_WidthInBytes_val9 \
    op interface \
    ports { WidthInBytes_val9 { I 15 vector } WidthInBytes_val9_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 107 \
    name colorFormat_val10 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_colorFormat_val10 \
    op interface \
    ports { colorFormat_val10 { I 3 vector } colorFormat_val10_ap_vld { I 1 bit } } \
} "
}

; ModuleID = '/home/e/Documents/research/byotee/OSDZU3_Ref_Design/OSDZU3_Ref_Design.runs/design_1_v_frmbuf_rd_1_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %4 = bitcast %"struct.ap_uint<64>"* %frm_buffer3 to [2073600 x %"struct.ap_uint<64>"]*
  %5 = call i8* @malloc(i64 16588800)
  %frm_buffer3_copy = bitcast i8* %5 to [2073600 x i64]*
  %6 = getelementptr [2073600 x i64], [2073600 x i64]* %frm_buffer3_copy, i64 0, i64 0
  ...
  call fastcc void @copy_in([2073600 x %"struct.ap_uint<64>"]* nonnull %0, [2073600 x i64]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<64>"]* nonnull %2, [2073600 x i64]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<64>"]* nonnull %4, [2073600 x i64]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %m_axis_video, i24* nonnull align 512 %m_axis_video_copy.data, i3* nonnull align 512 %m_axis_video_copy.keep, i3* nonnull align 512 %m_axis_video_copy.strb, i1* nonnull align 512 %m_axis_video_copy.user, i1* nonnull align 512 %m_axis_video_copy.last, i1* nonnull align 512 %m_axis_video_copy.id, i1* nonnull align 512 %m_axis_video_copy.dest)
  call void @apatb_v_frmbuf_rd_hw(i16 %width, i16 %height, i16 %stride, i16 %video_format, [2073600 x i64]* %frm_buffer_copy, [2073600 x i64]* %frm_buffer2_copy, i64* %6, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  call void @copy_back([2073600 x %"struct.ap_uint<64>"]* %0, [2073600 x i64]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<64>"]* %2, [2073600 x i64]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<64>"]* %4, [2073600 x i64]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %m_axis_video, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  call void @free(i8* %1)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
...
define internal fastcc void @copy_in([2073600 x %"struct.ap_uint<64>"]* readonly "unpacked"="0", [2073600 x i64]* nocapture "unpacked"="1.0", [2073600 x %"struct.ap_uint<64>"]* readonly "unpacked"="2", [2073600 x i64]* nocapture "unpacked"="3.0", [2073600 x %"struct.ap_uint<64>"]* readonly "unpacked"="4", [2073600 x i64]* nocapture "unpacked"="5.0", %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* "unpacked"="6", i24* align 512 "unpacked"="7.0" %_V_data_V, i3* align 512 "unpacked"="7.1" %_V_keep_V, i3* align 512 "unpacked"="7.2" %_V_strb_V, i1* align 512 "unpacked"="7.3" %_V_user_V, i1* align 512 "unpacked"="7.4" %_V_last_V, i1* align 512 "unpacked"="7.5" %_V_id_V, i1* align 512 "unpacked"="7.6" %_V_dest_V) unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.52"(i24* align 512 %_V_data_V, i3* align 512 %_V_keep_V, i3* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %6)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %dst, i24* align 512 %src_V_data_V, i3* align 512 %src_V_keep_V, i3* align 512 %src_V_strb_V, i1* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i1* align 512 %src_V_id_V, i1* align 512 %src_V_dest_V)
  br label %ret
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.19"([2073600 x %"struct.ap_uint<64>"]* %0, [2073600 x i64]* %1)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.19"([2073600 x %"struct.ap_uint<64>"]* %2, [2073600 x i64]* %3)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.19"([2073600 x %"struct.ap_uint<64>"]* %4, [2073600 x i64]* %5)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %6, i24* align 512 %_V_data_V, i3* align 512 %_V_keep_V, i3* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V)
  ret void
}
...
define internal fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.19"([2073600 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [2073600 x i64]* nocapture readonly "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.22"([2073600 x %"struct.ap_uint<64>"]* nonnull %dst, [2073600 x i64]* %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.22"([2073600 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [2073600 x i64]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.29"([2073600 x i64]* %dst, [2073600 x %"struct.ap_uint<64>"]* nonnull %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.29"([2073600 x i64]* nocapture "unpacked"="0.0" %dst, [2073600 x %"struct.ap_uint<64>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.52"(i24* align 512 "unpacked"="0.0" %dst_V_data_V, i3* align 512 "unpacked"="0.1" %dst_V_keep_V, i3* align 512 "unpacked"="0.2" %dst_V_strb_V, i1* align 512 "unpacked"="0.3" %dst_V_user_V, i1* align 512 "unpacked"="0.4" %dst_V_last_V, i1* align 512 "unpacked"="0.5" %dst_V_id_V, i1* align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.55"(i24* align 512 %dst_V_data_V, i3* align 512 %dst_V_keep_V, i3* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
declare void @apatb_v_frmbuf_rd_hw(i16, i16, i16, i16, [2073600 x i64]*, [2073600 x i64]*, i64*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)
...
declare void @v_frmbuf_rd_hw_stub(i16 zeroext, i16 zeroext, i16 zeroext, i16 zeroext, %"struct.ap_uint<64>"* noalias nonnull, %"struct.ap_uint<64>"* noalias nonnull, %"struct.ap_uint<64>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull)

define void @v_frmbuf_rd_hw_stub_wrapper(i16, i16, i16, i16, [2073600 x i64]*, [2073600 x i64]*, i64*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  %18 = call i8* @malloc(i64 16588800)
  %19 = bitcast i8* %18 to [2073600 x %"struct.ap_uint<64>"]*
  %20 = bitcast i64* %6 to [2073600 x i64]*
  %21 = call i8* @malloc(i64 12)
  %22 = bitcast i8* %21 to %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*
  call void @copy_out([2073600 x %"struct.ap_uint<64>"]* %15, [2073600 x i64]* %4, [2073600 x %"struct.ap_uint<64>"]* %17, [2073600 x i64]* %5, [2073600 x %"struct.ap_uint<64>"]* %19, [2073600 x i64]* %20, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %22, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  %23 = bitcast [2073600 x %"struct.ap_uint<64>"]* %15 to %"struct.ap_uint<64>"*
  %24 = bitcast [2073600 x %"struct.ap_uint<64>"]* %17 to %"struct.ap_uint<64>"*
  %25 = bitcast [2073600 x %"struct.ap_uint<64>"]* %19 to %"struct.ap_uint<64>"*
  call void @v_frmbuf_rd_hw_stub(i16 %0, i16 %1, i16 %2, i16 %3, %"struct.ap_uint<64>"* %23, %"struct.ap_uint<64>"* %24, %"struct.ap_uint<64>"* %25, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %22)
  call void @copy_in([2073600 x %"struct.ap_uint<64>"]* %15, [2073600 x i64]* %4, [2073600 x %"struct.ap_uint<64>"]* %17, [2073600 x i64]* %5, [2073600 x %"struct.ap_uint<64>"]* %19, [2073600 x i64]* %20, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %22, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)

set moduleName AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_548_1
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "div", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln548", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln548 sc_in sc_lv 29 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln548", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "sext_ln548", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln548 { ap_none {  { sext_ln548 in_data 0 29 } } }

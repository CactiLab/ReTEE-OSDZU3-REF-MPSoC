...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_plane0_din { O 64 vector } bytePlanes_plane0_full_n { I 1 bit } bytePlanes_plane0_write { O 1 bit } bytePlanes_plane0_num_data_valid { I 11 vector } bytePlanes_plane0_fifo_cap { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_plane1_din { O 64 vector } bytePlanes_plane1_full_n { I 1 bit } bytePlanes_plane1_write { O 1 bit } bytePlanes_plane1_num_data_valid { I 11 vector } bytePlanes_plane1_fifo_cap { I 11 vector } } \
} "
}

...
module design_1_v_frmbuf_rd_1_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_548_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] mm_video_addr_read_reg_151;
reg   [11:0] x_fu_72;
wire   [11:0] add_ln548_fu_118_p2;
wire    ap_loop_init;
...
#0 mm_video_addr_read_reg_151 = 64'd0;
#0 x_fu_72 = 12'd0;
#0 ap_done_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        mm_video_addr_read_reg_151 <= 64'd0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln548_fu_112_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln548_fu_112_p2 == 1'd1))) begin
...
assign add_ln548_fu_118_p2 = (ap_sig_allocacmp_x_6 + 12'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = (((bytePlanes_plane0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mm_video_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((bytePlanes_plane0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mm_video_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((bytePlanes_plane0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mm_video_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((bytePlanes_plane0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_mm_video_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign bytePlanes_plane0_din = mm_video_addr_read_reg_151;

assign icmp_ln548_fu_112_p2 = ((ap_sig_allocacmp_x_6 == div) ? 1'b1 : 1'b0);
...
endmodule //design_1_v_frmbuf_rd_1_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_548_1

...
module design_1_v_mix_0_0_hls_deadlock_idx1_monitor ( // for module design_1_v_mix_0_0_v_mix_inst.grp_VMixHlsDataFlowFunction_fu_500
    input wire clock,
    input wire reset,
    input wire [9:0] axis_block_sigs,
    input wire [35:0] inst_idle_sigs,
    input wire [19:0] inst_block_sigs,
    output wire block
);
...
wire idx10_block;
wire idx14_block;
wire [19:0] process_idle_vec;
wire [19:0] process_chan_block_vec;
wire [19:0] process_axis_block_vec;
...
assign process_axis_block_vec[4] = idx6_block & (1'b0 | axis_block_sigs[3] | axis_block_sigs[4] | axis_block_sigs[5]);
...
assign process_axis_block_vec[10] = idx10_block & (1'b0 | axis_block_sigs[6] | axis_block_sigs[7] | axis_block_sigs[8]);
...
assign process_axis_block_vec[19] = idx14_block & (1'b0 | axis_block_sigs[9]);
...
// instant sub module
 design_1_v_mix_0_0_hls_deadlock_idx2_monitor design_1_v_mix_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 design_1_v_mix_0_0_hls_deadlock_idx6_monitor design_1_v_mix_0_0_hls_deadlock_idx6_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 design_1_v_mix_0_0_hls_deadlock_idx10_monitor design_1_v_mix_0_0_hls_deadlock_idx10_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),

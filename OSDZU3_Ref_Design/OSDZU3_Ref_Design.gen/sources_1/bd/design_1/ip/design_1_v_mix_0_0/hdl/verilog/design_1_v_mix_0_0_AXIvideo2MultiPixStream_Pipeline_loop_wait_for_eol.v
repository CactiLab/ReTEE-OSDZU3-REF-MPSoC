...
module design_1_v_mix_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol (
        ...
        s_axis_video2_TDEST,
        axi_data_19_i_out,
        axi_data_19_i_out_ap_vld,
        axi_last_23_i_out,
        axi_last_23_i_out_ap_vld
);
...
input  [23:0] axi_data_18_i_reload;
...
output  [23:0] axi_data_19_i_out;
output   axi_data_19_i_out_ap_vld;
output  [0:0] axi_last_23_i_out;
output   axi_last_23_i_out_ap_vld;

reg ap_idle;
reg s_axis_video2_TREADY;
reg[23:0] axi_data_19_i_out;
reg axi_data_19_i_out_ap_vld;
reg axi_last_23_i_out_ap_vld;
...
always @ (*) begin
    if ((((ap_loop_init == 1'b1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b0 == ap_block_state1_pp0_stage0_iter0) & (ap_phi_mux_eol_phi_fu_117_p4 == 1'd0) & (1'b1 == ap_CS_fsm_state1)))) begin
        axi_data_19_i_out_ap_vld = 1'b1;
    end else begin
        axi_data_19_i_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (ap_phi_mux_eol_phi_fu_117_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        axi_last_23_i_out_ap_vld = 1'b1;
    end else begin
        axi_last_23_i_out_ap_vld = 1'b0;
    end
end
...
assign axi_last_23_i_out = ap_phi_mux_axi_last_phi_fu_106_p4;

endmodule //design_1_v_mix_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol

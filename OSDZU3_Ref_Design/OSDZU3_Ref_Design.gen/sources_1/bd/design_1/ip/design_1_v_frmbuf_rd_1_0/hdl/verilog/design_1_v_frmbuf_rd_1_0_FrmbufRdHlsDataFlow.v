...
module design_1_v_frmbuf_rd_1_0_FrmbufRdHlsDataFlow (
        m_axis_video_TDATA,
        m_axis_video_TKEEP,
        m_axis_video_TSTRB,
        m_axis_video_TUSER,
        ...
        height_val4_ap_vld,
        WidthInBytes_val9_ap_vld,
        stride_val5_ap_vld,
        video_format_val7_ap_vld,
        ap_start,
        m_axis_video_TVALID,
        m_axis_video_TREADY,
        width_val1_ap_vld,
        colorFormat_val10_ap_vld,
        ap_done,
        ap_ready,
        ap_idle,
        ap_continue
...
input  [11:0] width_val1;
input  [11:0] height_val4;
input  [15:0] stride_val5;
input  [5:0] video_format_val7;
input  [14:0] WidthInBytes_val9;
input  [2:0] colorFormat_val10;
input   ap_clk;
input   ap_rst;
input   HwReg_frm_buffer_ap_vld;
input   HwReg_frm_buffer2_ap_vld;
input   height_val4_ap_vld;
input   WidthInBytes_val9_ap_vld;
input   stride_val5_ap_vld;
input   video_format_val7_ap_vld;
input   ap_start;
output   m_axis_video_TVALID;
input   m_axis_video_TREADY;
input   width_val1_ap_vld;
input   colorFormat_val10_ap_vld;
output   ap_done;
output   ap_ready;
output   ap_idle;
input   ap_continue;
...
wire   [63:0] AXIMMvideo2Bytes_U0_bytePlanes_plane0_din;
wire    AXIMMvideo2Bytes_U0_bytePlanes_plane0_write;
wire   [63:0] AXIMMvideo2Bytes_U0_bytePlanes_plane1_din;
...
wire   [10:0] bytePlanes_plane1_num_data_valid;
wire   [10:0] bytePlanes_plane1_fifo_cap;
wire    img_full_n;
wire   [23:0] img_dout;
wire    img_empty_n;
...
design_1_v_frmbuf_rd_1_0_AXIMMvideo2Bytes AXIMMvideo2Bytes_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_rd_1_0_Bytes2MultiPixStream Bytes2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_rd_1_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_frmbuf_rd_1_0_fifo_w64_d961_B bytePlanes_plane0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_1_0_fifo_w64_d961_B bytePlanes_plane1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_1_0_fifo_w24_d2_S img_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_1_0_start_for_Bytes2MultiPixStream_U0 start_for_Bytes2MultiPixStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_1_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //design_1_v_frmbuf_rd_1_0_FrmbufRdHlsDataFlow

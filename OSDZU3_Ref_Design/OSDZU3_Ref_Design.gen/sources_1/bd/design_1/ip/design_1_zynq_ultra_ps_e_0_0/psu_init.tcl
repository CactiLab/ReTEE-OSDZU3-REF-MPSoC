...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A002C 0x00717F00 0x00015000
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01011402
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070024 0xFFFFFFFF 0x0028B090
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x00E32DCB
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B01006
    ...
    mask_write 0XFF180160 0x03FFFFFF 0x03FBFFFF

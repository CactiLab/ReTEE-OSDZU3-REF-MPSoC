/* Rename embench API for combined build */
#define initialise_benchmark sglib_combined_initialise_benchmark
#define warm_caches          sglib_combined_warm_caches
#define benchmark            sglib_combined_benchmark
#define verify_benchmark     sglib_combined_verify_benchmark
